...
# Configure Freetype
if (WIN32)
    message(" > Configuring Freetype for Win32")
    set(Freetype_BASE_DIR "${CMAKE_CURRENT_LIST_DIR}/libs/freetype-2.13.2")
...
elseif(EMSCRIPTEN)
    ...
    message(ERROR "-> Could not configure Freetype: Unknown platform")
endif()
